...
if(isset($_SESSION['valdi'])) {
    if (isset($_POST['edit'])) {
        ...
        $spek = mysqli_real_escape_string($koneksi, $spek);
        $harga = mysqli_real_escape_string($koneksi, $harga);
        $stok = mysqli_real_escape_string($koneksi, $stok);

        $edit = mysqli_query($koneksi, "UPDATE produk SET nama_produk='$nama_produk', spek='$spek', harga='$harga', stok='$stok' WHERE id='$id'");
                ...
                <div class="order">
					...
					<form method="post" action="">
						...
						<div class="field input">
							...
							<input  type="text" name="spek" value="<?php echo $obj->spek; ?>" required></input>
						</div>
						<div class="field input">
