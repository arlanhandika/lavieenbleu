...
if(isset($_SESSION['valdi'])) {
    if(isset($_POST['simpan'])){
		...
		$harga = $_POST['harga'];
		$stok = $_POST['stok'];
		$insert = mysqli_query($koneksi, "INSERT INTO produk (gambar, nama_produk, spek, harga, stok) VALUES ('$name_p', '$nama_produk', '$spek', '$harga', '$stok')");
			...
			<div class="table-data-produk">
				<div class="order">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
						...
						<div class="field input">
							<label for="spek">Masukkan Spesifikasi Produk</label>
							<input type="text" name="spek" required></input>
						</div>
						<div class="field input">
