<?php
  ...
  if(isset ($_POST['submit_kontak'])){
    ...
    if (empty($email) || empty($nama)){
        ...
        echo "<script>alert('Pesan berhasil dikirim'); window.location.href='testimonials.php';</script>";
    }
  }
?>
<!DOCTYPE html>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>TESTIMONI</h1>
            <span>Ulasan dari klien-klien terbaik kami</span>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-12">
            <div class="owl-testimonials owl-carousel">
              ...
              <div class="testimonial-item">
                ...
                <img src="assets/images/hanni.jpg" alt="">
                  <h4>Hanni Pham</h4>
              ...
              <div class="testimonial-item">
                <div class="inner-content">
                <img src="assets/images/Hamba Allah.jpg" alt="">
                  <h4>Hamba Allah</h4>
                  <span>Senior Cipung</span>
                  <p>"Ingin rasanya membeli semua barang yang ada."</p>
                </div>
              </div>

              <div class="testimonial-item">
                <div class="inner-content">
                <img src="assets/images/Orang Luar Biasa.jpg" alt="">
                  <h4>Orang Luar Biasa</h4>
                  <span>Manusia Luar Biasa</span>
                  <p>"Ahhh mantap kali beli di sini bahhh."</p>
                </div>
              </div> 
